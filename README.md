...
- [ ] **Contract closeout** — freezing the fact, receipt and IR contracts is a semantic commitment, not a publishing act. The three questions it had to answer are decided in [spec/compatibility.md](spec/compatibility.md); what remains is enforcing the review-resolution rule in `duly_review`.
