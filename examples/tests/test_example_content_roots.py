...
Extracted from `duly_demo/tests/test_content_roots.py`, which asserts M5 decision
...
duly_demo.app:app` with no configuration at all serves six packs and a golden
...
def test_the_repo_default_still_finds_everything():
    ...
    content = duly_demo.content.CONTENT
