...
**Adding a starter is step 3 of authoring a rule pack.** The full path, including the three things that are *not* auto-discovered and the constraints that will bite you, is in [examples/rulepacks/README.md](../rulepacks/README.md).
