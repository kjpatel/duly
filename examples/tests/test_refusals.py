...
The subject here is the committed `examples/dmn/refusals/` documents: that
each one still refuses, for the reason its README says, and that none has been
added without a test. What the *compiler* refuses in general is asserted in
`dmn/tests/` against `fixtures/dmn/refusals`, which survives this tree.
"""
...
from exampletest_helpers import REFUSALS, refusal_value_kinds
